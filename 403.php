...
?></h3>
			...
			<div id="content">
				...
				<div>
					<h1 style="display: inline">403 Takeoff rejected.</h1>
					<div style="margin-top: 1em">Access to the request page
					<span style="font-style: italic; color: #00007f">
						<?php echo "http".(isset($_SERVER['HTTPS']) ? "s" : "")."://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]"; ?>
					</span> has been denied.
					This might happen due to access restrictions or an errorneous request.</div>
