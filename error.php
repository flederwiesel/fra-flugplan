...
$root = "{$_SERVER['DOCUMENT_ROOT']}$thisdir";

if (is_file("{$root}/classes/etc.php"))
	require_once "{$root}/classes/etc.php";

if (is_file("{$root}/classes/assets.php"))
	require_once "{$root}/classes/assets.php";
...
<head>
	...
	<link rel="stylesheet" type="text/css" media="screen, print" href="<?= Asset::ref("error.css") ?>">
</head>
<body>
	<div class="container" id="container">
		<h1 id="title">FRA Flugplan</h1>
		<h2 id="subtitle"><?= $subtitle ?></h2>
		<img src="<?= Asset::ref("img/errors/{$status}.gif") ?>" alt="<?= $status ?>">
