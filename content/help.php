...
<div style="max-width: 792px;">
	...
	<div>
		...
		<ul class="naked help">
			...
			<li><?= $HELPSTRINGS[16] ?>.
			<li class="img">
				<img class="screen" src="<?= Asset::ref("content/img/{$_SESSION['lang']}/1-basic.png") ?>">
		...
		<ul class="naked help">
			...
			<li><?= $HELPSTRINGS[19] ?>
			<li class="img">
				<img class="screen" src="<?= Asset::ref("content/img/{$_SESSION['lang']}/2-watchlist.png") ?>">
				<a class="back" href="#"><?= $HELPSTRINGS[0] ?></a>
			</li>
		</ul>
		...
		<ul class="naked help">
			...
			<li><?= $HELPSTRINGS[23] ?>.
			<li class="img">
				<img class="screen" src="<?= Asset::ref("content/img/{$_SESSION['lang']}/3-watchlist-def.png") ?>">
				<a class="back" href="#"><?= $HELPSTRINGS[0] ?></a>
			</li>
		</ul>
		...
		<ul class="naked help">
			<li><?= $HELPSTRINGS[24] ?>.
			<li class="img">
				<img class="screen" src="<?= Asset::ref("content/img/{$_SESSION['lang']}/4-sorting.png") ?>">
				<a class="back" href="#"><?= $HELPSTRINGS[0] ?></a>
			</li>
		</ul>
		...
		<ul class="naked help">
			<li><?= $HELPSTRINGS[25] ?>.
			<li class="img">
				<img class="screen" src="<?= Asset::ref("content/img/{$_SESSION['lang']}/5-sorting-reg.png") ?>">
				<a class="back" href="#"><?= $HELPSTRINGS[0] ?></a>
			</li>
		</ul>
		...
		<ul class="help">
			<li><?= $HELPSTRINGS[26] ?>.
				<div><?= $HELPSTRINGS[31] ?>:
					<div id="mobile">
						<ul class="help">
							<li><img src="<?= Asset::ref("img/arrival-grey-24x24.png") ?>"><?= $STRINGS["arrival"] ?></li>
							<li><img src="<?= Asset::ref("img/departure-grey-24x24.png") ?>"><?= $STRINGS["departure"] ?></li>
							<li><img src="<?= Asset::ref("img/help-grey-24x24.png") ?>"><?= $STRINGS["help"] ?></li>
							<li><img src="<?= Asset::ref("img/register-grey-24x24.png") ?>"><?= $STRINGS["register"] ?></li>
							<li><img src="<?= Asset::ref("img/login-grey-24x24.png") ?>"><?= $STRINGS["login"] ?></li>
							<li><img src="<?= Asset::ref("img/logout-grey-24x24.png") ?>"><?= $STRINGS["logout"] ?></li>
							<li><img src="<?= Asset::ref("img/profile-grey-24x24.png") ?>"><?= $STRINGS["profile"] ?></li>
							<li>&nbsp;</li>
							<li><img src="<?= Asset::ref("img/dispinterval-grey-24x24.png") ?>"><?= $STRINGS["dispinterval"] ?></li>
							<li><img src="<?= Asset::ref("img/notifinterval-grey-24x24.png") ?>"><?= $STRINGS["notifinterval"] ?></li>
							<li><img src="<?= Asset::ref("img/changepw-grey-24x24.png") ?>"><?= $STRINGS["changepw"] ?></li>
						</ul>
					</div>
				</div>
			</li>
		...
		<ul class="naked help">
			...
			<div>
				<ul class="help">
					...
					<li><a href="http://www.kryogenix.org/code/browser/sorttable/">SortTable <?= $HELPSTRINGS[29] ?> Stuart Langridge</a></li>
