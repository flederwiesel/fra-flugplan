...
check "3" browse "$url/?req=login"
check "4" browse "$url/?req=login" --data-urlencode "user="
check "5" browse "$url/?req=login" --data-urlencode "passwd="
check "6" browse "$url/?req=login" --data-urlencode "user=" --data-urlencode "passwd=elvizzz"
check "7" browse "$url/?req=login" --data-urlencode "user=flederwiesel" --data-urlencode "passwd="
